...
Index of UX tools. Each tool is a standalone, single `index.html` file that works offline and stores data in localStorage/IndexedDB.

Build rules and design system: see [`../CLAUDE.md`](../CLAUDE.md).
...
| [name](./name/) | One-sentence description | [Open](https://marekbrze.github.io/ux-tools/apps/name/) |
-->
